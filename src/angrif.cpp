...
int decode_griffin_event( unsigned int *evntbuf, int evntbuflen)
{
	...
	if ( (curr_time - last_update) >= RATE_COUNT_INTERVAL ) {
		report_counts_grif(curr_time - last_update);
		...
		case 0x4: case 0x5: case 0x6: case 0x7:
          ...
          ptr->nhit = 1;
					...
					ptr->integ4 = ((val32 & 0x3FFF0000) >> 16);
					                        ...
					                        ptr->e4_bad  = (val32 >> 25) & 0x1;} else if( qtcount == 7 ) { ptr->energy4 =  val32 & 0x3FFFFF;
					                                                                                       ptr->e4_bad  = (val32 >> 25) & 0x1;} else {
...
//   chan = ptr->address;
  ...
  grif16_tdc_last_time = ptr->timestamp;
