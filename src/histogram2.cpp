...
int TH2IHist_Fill(TH2IHist *thisptr, int binx, int biny, int rowl, int count)
{
	(thisptr->entries)++;
...
int TH2IHist_SetBinContent(TH2IHist *thisptr, int bin, int value)
{
...
TH2IHist *H2_BOOK(char *name, char *title, int nbins, int arg2, int arg3)
{
